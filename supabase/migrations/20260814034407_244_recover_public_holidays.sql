-- ★ MIGRATION: 244_recover_public_holidays.sql
-- Schema version: v5.55
-- Description: Support — public holiday calendar for delivery deadline automation (RECOVERY)
-- Dependencies: (none)
-- Author: Stephen Cconzy
-- Date: 2026-08-14
--
-- 복구 사유: 원본 20260529000026_26_public_holidays.sql이 같은 2026-05-29 배치에서 누락됨
-- (2026-08-13 세션에서 cs_posts 점검 중 형제 파일 22~28 전수 대조로 함께 발견).
-- 원본 파일은 수정하지 않고 동일 내용(2026년 초기 공휴일 시드 데이터 포함)을 신규 파일로 적용함.
--
