-- Migration 487: update_reservation_status에 'expired'를 종료(terminal) 상태로 추가
-- (원래 485로 적용됐으나 같은 세션의 다른 마이그레이션과 번호가 중복돼 487로 리네임됨,
-- 2026-09-10 — Stephen 확인 후 이 세션에서 리네임 실행. DB 적용 이력 자체는 무변경.)
--
...
BEGIN
  ...
  -- 'expired' 추가(Migration #487) — HOLD 30분 자동만료도 completed/cancelled/
