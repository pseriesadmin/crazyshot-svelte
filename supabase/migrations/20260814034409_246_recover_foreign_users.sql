-- ★ MIGRATION: 246_recover_foreign_users.sql
-- Schema version: v5.55
-- Description: Support — foreign user extended authentication info (외국인 인증) (RECOVERY)
-- Dependencies: 03_user_profiles.sql
-- Author: Stephen Cconzy
-- Date: 2026-08-14
--
-- 복구 사유: 원본 20260529000028_28_foreign_users.sql이 같은 2026-05-29 배치에서 누락됨.
-- 원본 파일은 수정하지 않고 동일 내용을 신규 파일로 적용함.
--
...
-- ROLLBACK:
-- DROP TABLE IF EXISTS foreign_users CASCADE;
