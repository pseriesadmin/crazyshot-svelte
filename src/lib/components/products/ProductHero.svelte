  ...
  <header class="sub-gnb-b">
    <div class="sub-gnb-b-inner">
      ...
      <div class="sub-gnb-b-cats">
        <button class="sub-gnb-b-cat-btn" title="카메라" type="button">
          <svg class="sub-gnb-b-cat-svg" viewBox="0 0 31.5078 33.5626" fill="none" aria-hidden="true">
        ...
        <button class="sub-gnb-b-cat-btn" title="렌즈" type="button">
          <svg class="sub-gnb-b-cat-svg" viewBox="0 0 32 27.1304" fill="none" aria-hidden="true">
        ...
        <button class="sub-gnb-b-cat-btn" title="드론" type="button">
          <svg class="sub-gnb-b-cat-svg" viewBox="0 0 32.8777 32.8777" fill="none" aria-hidden="true">
        ...
        <button class="sub-gnb-b-cat-btn" title="폰" type="button">
          <svg class="sub-gnb-b-cat-svg" viewBox="0 0 32 29" fill="none" aria-hidden="true">
        ...
        <button class="sub-gnb-b-cat-btn" title="영상" type="button">
          <svg class="sub-gnb-b-cat-svg" viewBox="0 0 32 20.9674" fill="none" aria-hidden="true">
        ...
        <button class="sub-gnb-b-cat-btn" title="악세서리" type="button">
          <svg class="sub-gnb-b-cat-svg" viewBox="0 0 30 30" fill="none" aria-hidden="true">
        ...
        <button class="sub-gnb-b-cat-btn" title="항공" type="button">
          <svg class="sub-gnb-b-cat-svg" viewBox="0 0 32 26" fill="none" aria-hidden="true">
        ...
        <button class="sub-gnb-b-cat-btn" title="기타" type="button">
          <svg class="sub-gnb-b-cat-svg" viewBox="0 0 28 32" fill="none" aria-hidden="true">
